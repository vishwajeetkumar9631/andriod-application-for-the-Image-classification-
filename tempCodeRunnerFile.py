...
MODEL_PATH = r'E:\image_classification_backend\models\my_image_classifier.h5'
try:
...
CLASS_NAMES = ['cat', 'dog', 'bird']  # Replace with your model's class labels
TARGET_IMAGE_SIZE = (224, 224)  # Adjust based on your model's input size
